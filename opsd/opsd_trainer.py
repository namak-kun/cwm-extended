...
from trl.experimental.utils import truncate_dataset  # CWM-port: moved in trl>=1.x
from trl.extras.profiling import profiling_decorator
try:  # CWM-port: VLLMClient moved trl.extras.vllm_client -> trl.generation.vllm_client in trl>=1.x
    from trl.generation.vllm_client import VLLMClient
except Exception:
    VLLMClient = None
from trl.import_utils import is_vllm_available
from trl.models.utils import prepare_deepspeed  # CWM-port: moved trl.models -> trl.models.utils in trl>=1.x
...
from trl.experimental.utils import DataCollatorForChatML  # CWM-port: moved in trl>=1.x
try:  # CWM-port: empty_cache moved to trl.generation.vllm_generation in trl>=1.x
